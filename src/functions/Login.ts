...
//     if (ahkProcess) return; // tránh chạy trùng

//     const script = path.join(__dirname, "cancel_popup.ahk");
//     console.log("Script path: " + script)

//     ahkProcess = spawn("AutoHotkey.exe", [script], {
//         windowsHide: true,
//         detached: false
//     });
...
// export function stopAutoCancel() {
//     if (ahkProcess) {
//         ahkProcess.kill();
//         ahkProcess = null;
//     }
